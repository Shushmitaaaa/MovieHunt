...
const App=()=>{
  ...
  const [isLoading,setIsLoading]=useState(false);//fetching data from api might take time hence loader
  ...
  const fetchMovies = async(query='')=>{
    ...
    try{
      ...
      setErrorMessage('Error fetching movies.Plesae try again later')
    }finally{
      setIsLoading(false);
    }
  }
